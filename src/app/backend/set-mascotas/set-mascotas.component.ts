...
@Component({
  selector: 'app-set-mascotas',
  templateUrl: './set-mascotas.component.html',
  styleUrls: ['./set-mascotas.component.scss'],
})
export class SetMascotasComponent implements OnInit {
